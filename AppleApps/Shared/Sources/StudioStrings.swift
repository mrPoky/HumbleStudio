...
enum StudioStrings {
    ...
    static let supportedAppLaunchIntent = String(localized: "studio.remote_source.supported_app_launch_intent", defaultValue: "Launch")
    ...
    static let supportedAppRecoveryWizard = String(localized: "studio.remote_source.supported_app_recovery_wizard", defaultValue: "Recovery wizard")
    static let supportedAppSessionID = String(localized: "studio.remote_source.supported_app_session_id", defaultValue: "Session ID")
    static let supportedAppReviewArtifact = String(localized: "studio.remote_source.supported_app_review_artifact", defaultValue: "Review artifact")
    static let supportedAppStructuredDraft = String(localized: "studio.remote_source.supported_app_structured_draft", defaultValue: "Structured draft")
    static let supportedAppPatchPreview = String(localized: "studio.remote_source.supported_app_patch_preview", defaultValue: "Patch preview")
    static let supportedAppRuntimeReadiness = String(localized: "studio.remote_source.supported_app_runtime_readiness", defaultValue: "Runtime readiness")
    static let supportedAppProposalCenter = String(localized: "studio.remote_source.supported_app_proposal_center", defaultValue: "Proposal center")
    static let supportedAppPatchArtifact = String(localized: "studio.remote_source.supported_app_patch_artifact", defaultValue: "Patch artifact")
    static let supportedAppSandboxApply = String(localized: "studio.remote_source.supported_app_sandbox_apply", defaultValue: "Sandbox apply")
    static let supportedAppSourceApplyLock = String(localized: "studio.remote_source.supported_app_source_apply_lock", defaultValue: "Source apply lock")
    static let supportedAppTrustLevel = String(localized: "studio.remote_source.supported_app_trust_level", defaultValue: "Trust level")
    static let supportedAppConnectionRegistry = String(localized: "studio.remote_source.supported_app_connection_registry", defaultValue: "Connection registry")
    static let supportedAppNativeParity = String(localized: "studio.remote_source.supported_app_native_parity", defaultValue: "Native parity")
