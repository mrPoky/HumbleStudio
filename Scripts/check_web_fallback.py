...
def validate_local_preview_helper() -> list[str]:
    ...
    required_fragments = [
        ...
        (helper_content, "structuredDraft", "HumbleControl structured draft contract"),
        (helper_content, "structured-edit-draft", "HumbleControl structured edit draft capability"),
        (helper_content, "patchPreview", "HumbleControl patch preview contract"),
        (helper_content, "patch-preview", "HumbleControl patch preview capability"),
        (helper_content, "trustLevel", "HumbleControl trust level contract"),
        (helper_content, "manifest-trust-levels", "HumbleControl manifest trust capability"),
        (helper_content, "safeApplyBoundary", "HumbleControl safe apply boundary contract"),
        (helper_content, "safe-apply-boundary", "HumbleControl safe apply boundary capability"),
        (helper_content, "connectionRegistry", "HumbleControl connection registry contract"),
        (helper_content, "connection-registry", "HumbleControl connection registry capability"),
        (helper_content, "nativeParity", "HumbleControl native parity contract"),
        (helper_content, "native-parity-contract", "HumbleControl native parity capability"),
        (helper_content, "endToEndSmoke", "HumbleControl authoring smoke contract"),
        (helper_content, "authoring-e2e-smoke", "HumbleControl authoring smoke capability"),
        (helper_content, "runtimeReadiness", "HumbleControl runtime readiness contract"),
        (helper_content, "runtime-freshness", "HumbleControl runtime freshness capability"),
        (helper_content, "proposalCenter", "HumbleControl proposal center contract"),
        (helper_content, "proposal-center", "HumbleControl proposal center capability"),
        (helper_content, "patchArtifact", "HumbleControl patch artifact contract"),
        (helper_content, "patch-artifact", "HumbleControl patch artifact capability"),
        (helper_content, "sandboxApply", "HumbleControl sandbox apply contract"),
        (helper_content, "sandbox-apply", "HumbleControl sandbox apply capability"),
