const SUPPORTED_APP_SOURCES = [
  ...
  },
  {
    ...
    localSource: {
      type: 'localhost-api',
      value: '/api/supported-apps/my-vltava-run/export',
    },
  },
  {
    id: 'humble-control',
  ...
  },
  {
    ...
    sourceKind: 'design.json',
    badge: 'Fitness',
    description: 'Workout app export wired into the same Studio and Control connection path.',
    source: {
      type: 'url',
      value: 'https://raw.githubusercontent.com/mrPoky/HumbleWorkout/main/.humble/design.json',
    },
    localSource: {
      type: 'localhost-api',
      value: '/api/supported-apps/humble-workout/export',
    },
  },
  {
    id: 'humble-kakuro',
    ...
    sourceKind: 'design.json',
    badge: 'Puzzle',
    description: 'Kakuro design contract available through the shared Humble app registry.',
    source: {
      type: 'url',
      value: 'https://raw.githubusercontent.com/mrPoky/HumbleKakuro/main/.humble/design.json',
    },
    localSource: {
      type: 'localhost-api',
      value: '/api/supported-apps/humble-kakuro/export',
    },
  },
  {
    id: 'humble-cycling',
    ...
    sourceKind: 'design.json',
    badge: 'Cycling',
    description: 'Cycling app source truth surfaced for read-only Studio inspection.',
    source: {
      type: 'url',
      value: 'https://raw.githubusercontent.com/mrPoky/HumbleCycling/main/.humble/design.json',
    },
    localSource: {
      type: 'localhost-api',
      value: '/api/supported-apps/humble-cycling/export',
    },
  },
  {
    id: 'humble-home',
    ...
    sourceKind: 'design.json',
    badge: 'Home',
    description: 'Home app design export connected to the shared prepare-edit runway.',
    source: {
      type: 'url',
      value: 'https://raw.githubusercontent.com/mrPoky/HumbleHome/main/.humble/design.json',
    },
    localSource: {
      type: 'localhost-api',
      value: '/api/supported-apps/humble-home/export',
    },
  },
  {
    id: 'humble-cook',
    ...
    sourceKind: 'design.json',
    badge: 'Cooking',
    description: 'Cooking app contract available to Studio without repository writes.',
    source: {
      type: 'url',
      value: 'https://raw.githubusercontent.com/mrPoky/HumbleCook/main/.humble/design.json',
    },
    localSource: {
      type: 'localhost-api',
      value: '/api/supported-apps/humble-cook/export',
    },
  },
  {
    id: 'humble-architect',
    ...
    sourceKind: 'design.json',
    badge: 'Planning',
    description: 'Architecture workspace export registered for Control and Studio convergence.',
    source: {
      type: 'url',
      value: 'https://raw.githubusercontent.com/mrPoky/HumbleArchitect/main/.humble/design.json',
    },
    localSource: {
      type: 'localhost-api',
      value: '/api/supported-apps/humble-architect/export',
    },
  },
  {
    id: 'humble-nas',
    ...
    sourceKind: 'design.json',
    badge: 'Utility',
    description: 'NAS utility export included in the broader Humble app registry.',
    source: {
      type: 'url',
      value: 'https://raw.githubusercontent.com/mrPoky/HumbleNAS/main/.humble/design.json',
    },
    localSource: {
      type: 'localhost-api',
      value: '/api/supported-apps/humble-nas/export',
    },
  },
  {
    ...
    sourceKind: 'design.json',
    badge: 'Subscription',
    description: 'Subscription app export ready for the same read-only review workflow.',
    source: {
      type: 'url',
      value: 'https://raw.githubusercontent.com/mrPoky/HumbleSubscription/main/.humble/design.json',
    },
    localSource: {
      type: 'localhost-api',
      value: '/api/supported-apps/humble-subscription/export',
    },
  },
  {
    id: 'my-family',
    ...
    sourceKind: 'design.json',
    badge: 'Family',
    description: 'Family app contract included for future Control-owned editing workflows.',
    source: {
      type: 'url',
      value: 'https://raw.githubusercontent.com/mrPoky/MyFamily/main/.humble/design.json',
    },
    localSource: {
      type: 'localhost-api',
      value: '/api/supported-apps/my-family/export',
    },
  },
];
